...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b, and vice verse ', function () {
        it('a=8 is friend of b=7 == is true   &&   b=7 is friend of a=8 == is false', function () {
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b, and vice verse ', function () {
        it('a=220 is friend of b=284 == is true   &&   b=284 is friend of a=220 == is true', function () {
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b, and vice verse ', function () {
        it('a=6 is friend of b=6 == is true   &&   b=6 is friend of a=6 == is true', function () {
            var expected = [true,true];
            var actual;
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b ', function () {
        it('a=8 is friend of b=7 == is true', function () {
            var expected = true;
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b ', function () {
        it('a=-8 is friend of b=7 == is false', function () {
            var expected = false;
            var actual = numbers.aFriendOfb(-8,7);
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of a is equal than b ', function () {
        it('a=10 is friend of b=14 == is false', function () {
            var expected = false;
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of b is equal than a ', function () {
        it('b=7 is friend of a=8 == is false', function () {
            var expected = false;
...
describe('Two numbers are friends', function () {
    context('The sum of the dividers of b is equal than a ', function () {
        it('b=14 is friend of a=10 == is true', function () {
            var expected = true;
